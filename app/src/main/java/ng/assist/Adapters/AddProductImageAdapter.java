...
public class AddProductImageAdapter extends RecyclerView.Adapter<AddProductImageAdapter.itemViewHolder> {
    ...
    ArrayList<EcommerceDashboardModel.ProductImageModel> imagesList;
    Context context;


    public AddProductImageAdapter(ArrayList<EcommerceDashboardModel.ProductImageModel> imagesList, Context context){
    ...
    public void addItem(EcommerceDashboardModel.ProductImageModel imageModel){
