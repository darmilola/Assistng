...
import ng.assist.AccomodationApprovalDetails;
import ng.assist.AccomodationBooking;
import ng.assist.R;
import ng.assist.UIs.ViewModel.AccomodationListModel;

public class AccomodationApprovalAdapter extends RecyclerView.Adapter<AccomodationApprovalAdapter.AccomodationItemViewHolder> {

    ArrayList<AccomodationListModel> accomodationList;
    Context context;


    public AccomodationApprovalAdapter(ArrayList<AccomodationListModel> accomodationList, Context context){
        ...
        public AccomodationItemViewHolder(View ItemView){
            ...
            ItemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, AccomodationApprovalDetails.class);
