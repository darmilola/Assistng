...
public class GroceryDetailProductAdapter extends RecyclerView.Adapter<GroceryDetailProductAdapter.itemViewHolder> {

    ArrayList<GroceryModel> groceryList;
    Context context;


    public GroceryDetailProductAdapter(ArrayList<GroceryModel> groceryList, Context context){
