...
public class CompletedBooking extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_completed_booking, container, false);
        initView();
        return  view;
    }
    ...
    private void initView(){
        ...
        providerBookingsModel = new ProviderBookingsModel(userEmail,"Completed",getContext());
