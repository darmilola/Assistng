...
public class PersonalServicesDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_services_details);
        initView();
    }
    ...
    private void initView(){
        ...
        serviceCategoryAdapter = new ServiceCategoryAdapter(categoryList,PersonalServicesDetails.this);
        ...
        servicesModel.setServiceProviderListener(new ServicesModel.ServiceProviderListener() {
            ...
            public void onProvidersReadyListener(ArrayList<ServicesModel> servicesModelArrayList, String nextPageUrl, String totalPage) {
                PersonalServicesDetails.this.nextPageUrl = nextPageUrl;
                serviceProvidersAdapter = new ServiceProvidersAdapter(servicesModelArrayList,PersonalServicesDetails.this);
            ...
            public void onError(String message) {
                rootLayout.setVisibility(View.VISIBLE);
                loadingProgress.setVisibility(View.GONE);
                Toast.makeText(PersonalServicesDetails.this, "No provider available for this location", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        changeLocationLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listDialog = new ListDialog(locationList,PersonalServicesDetails.this);
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!recyclerView.canScrollVertically(1)){ //1 for down
                    ...
                    servicesModel.setServiceProviderListener(new ServicesModel.ServiceProviderListener() {
                        ...
                        public void onError(String message) {
                            recyclerProgress.setVisibility(View.GONE);
                            Toast.makeText(PersonalServicesDetails.this, message, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
    ...
    private void populateCategory(){
        categoryList.add("Hair Salon");
        categoryList.add("Barbing Salon");
        categoryList.add("Makeup Artist");
        categoryList.add("Massage Therapy");
    }
