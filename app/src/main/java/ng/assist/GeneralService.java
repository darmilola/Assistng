...
public class GeneralService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_services_details);
        initView();
    }
    ...
    private void initView(){
        ...
        ServicesModel servicesModel = new ServicesModel("General Services","Lagos");
        ...
        servicesModel.setServiceProviderListener(new ServicesModel.ServiceProviderListener() {
            ...
            public void onProvidersReadyListener(ArrayList<ServicesModel> servicesModelArrayList, String nextPageUrl, String totalPage) {
                GeneralService.this.nextPageUrl = nextPageUrl;
                serviceProvidersAdapter = new ServiceProvidersAdapter(servicesModelArrayList,GeneralService.this);
            ...
            public void onError(String message) {
                rootLayout.setVisibility(View.VISIBLE);
                loadingProgress.setVisibility(View.GONE);
                Toast.makeText(GeneralService.this, "No provider available for this location", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        changeLocationLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listDialog = new ListDialog(locationList,GeneralService.this);
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!recyclerView.canScrollVertically(1)){ //1 for down
                    ...
                    servicesModel.setServiceProviderListener(new ServicesModel.ServiceProviderListener() {
                        ...
                        public void onError(String message) {
                            recyclerProgress.setVisibility(View.GONE);
                            Toast.makeText(GeneralService.this, message, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
